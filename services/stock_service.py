...
from collectors.fmp_collector import fetch_stock_profiles
...
def collect_stock_profiles_fmp(session: Session, symbols: list[str]):
    """
    FMP API를 통해 주식 기본정보(회사명, 섹터 등)를 수집하고 DB에 저장
    """
    ...
    print(f"✅ {len(profiles)}개 종목 프로필 저장 완료")
